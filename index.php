...
if(in_array($page,['services','home','dashboard','account','admin'],true)){
    try{$services=cachedProviderServices('/var/www/html/data',300);}catch(Throwable $x){$apiError='Service API unavailable';}
}
