...
final class JsonStore {
    ...
    public function updateOrderStatus(int $id,string $status): bool { return $this->mutate(function(&$d)use($id,$status){foreach($d['orders'] as &$o)if((int)$o['id']===$id){$o['status']=$status;return true;}return false;}); }
